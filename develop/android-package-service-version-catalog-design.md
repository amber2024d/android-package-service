...
> 状态：**已落地（阶段 10–17，2026-06）**。本文沉淀「多源整合的版本目录 + 名↔号沉淀 + 缓存」的设计，
> 取代了原散落在各 provider 里的版本获取逻辑。各 §/决策的落地情况已就地标注「落地（阶段 N）」；
> 阶段拆分与状态见 [phases/README.md](phases/README.md)，源码入口见 [PROJECT_MAP.md](../PROJECT_MAP.md)。
>
